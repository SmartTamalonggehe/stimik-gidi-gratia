...
class PersembahanController extends Controller
{
    ...
    protected function spartaValidation($request, $id = "")
    {
        ...
        $rules = [
            'jenis_id' => 'required',
            'nm_persembahan' => 'required',
        ];

        $messages = [
            'jenis_id.required' => 'Jenis harus diisi.',
            'nm_persembahan.required' => 'Nama persembahan harus diisi.',
        ];
    ...
    {
        $data = Persembahan::with('jenis')->get();
    ...
    {
        $data = Persembahan::findOrFail($id);
