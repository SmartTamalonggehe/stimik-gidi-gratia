                    ...
                    <div data-simplebar class="dropdown-body p-2">
                            ...
                            <div class="media align-items-center">
                                <div class="media-head me-2">
                                    <div class="avatar avatar-xs avatar-rounded">
                                        <img src="{{ asset('assets_admin/dist/img/avatar3.jpg') }}" alt="user"
                                            class="avatar-img">
                                    </div>
                                </div>
                                <div class="media-body">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item">
                            <div class="media align-items-center">
                                <div class="media-head me-2">
                                    <div class="avatar avatar-xs avatar-rounded">
                                        <img src="{{ asset('assets_admin/dist/img/avatar4.jpg') }}" alt="user"
                                            class="avatar-img">
                                    </div>
                                </div>
                                <div class="media-body">
                            ...
                            <div data-simplebar class="dropdown-body  p-2">
                                    ...
                                    <div class="media">
                                        <div class="media-head">
                                            <div class="avatar avatar-rounded avatar-sm">
                                                <img src="{{ asset('assets_admin/dist/img/avatar2.jpg') }}"
                                    ...
                                    <div class="media">
                                        <div class="media-head">
                                            <div class="avatar avatar-sm avatar-rounded">
                                                <img src="{{ asset('assets_admin/dist/img/avatar3.jpg') }}"
                                                    alt="user" class="avatar-img">
                                            </div>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <div class="media">
                                        <div class="media-head">
                                            <div class="avatar avatar-sm avatar-rounded">
                                                <img src="{{ asset('assets_admin/dist/img/avatar10.jpg') }}"
                                                    alt="user" class="avatar-img">
                                            </div>
                                        </div>
                                        <div class="media-body">
                    ...
                    <div class="dropdown ps-2">
                        <a class=" dropdown-toggle no-caret" href="#" role="button" data-bs-display="static"
                            ...
                            <div class="avatar avatar-rounded avatar-xs">
                                <img src="{{ asset('assets_admin/dist/img/avatar12.jpg') }}" alt="user"
                                    class="avatar-img">
                            </div>
                        </a>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <div class="p-2">
                                                    ...
                                                    <div class="media align-items-center mb-3">
                                                        <div class="media-head me-2">
                                                            <div class="avatar avatar-xs avatar-rounded">
                                                                <img src="{{ asset('assets_admin/dist/img/avatar12.jpg') }}"
                                                                    alt="user" class="avatar-img">
                                                            </div>
                                                        </div>
                                                        <div class="media-body">
